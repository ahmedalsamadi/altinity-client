...
const Profile = ({ getProfileById, profiles: { profile, loading } }) => {
  let { id } = useParams();
        ...
        {loading || profile === null ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Education Timeline */}
              <div className="glass-strong rounded-2xl p-6 shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-fuchsia-500 bg-clip-text text-transparent mb-6">
                  Education
                </h3>
